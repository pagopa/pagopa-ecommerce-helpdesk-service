...
//ONLY API
tasks.register<org.openapitools.generator.gradle.plugin.tasks.GenerateTask>("helpdesk-v1-api") {
...
//ONLY API
tasks.register<org.openapitools.generator.gradle.plugin.tasks.GenerateTask>("helpdesk-v2-api") {
    generatorName.set("jaxrs-spec")
    inputSpec.set("$rootDir/api-spec/v2/openapi.yaml")
    outputDir.set(layout.buildDirectory.get().dir("generated").asFile.toString())
    apiPackage.set("it.pagopa.generated.ecommerce.helpdesk.v2.api")
...
//ONLY-API
tasks.register<org.openapitools.generator.gradle.plugin.tasks.GenerateTask>("nodo-api") {
    generatorName.set("jaxrs-spec")
    remoteInputSpec.set(
        "https://raw.githubusercontent.com/pagopa/pagopa-infra/v1.465.0/src/core/api/nodopagamenti_api/nodoPerPM/v2/_openapi.json.tpl"
    )
...
tasks.register("generateHelpdeskAll") {
    group = "openapi"
    description = "Genera sia model che API per Helpdesk"

    dependsOn("helpdesk-v1", "helpdesk-v2", "nodo","helpdesk-v1-api", "helpdesk-v2-api", "nodo-api")
}
