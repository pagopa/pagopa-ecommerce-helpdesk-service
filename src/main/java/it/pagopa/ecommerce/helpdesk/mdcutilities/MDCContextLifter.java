package it.pagopa.ecommerce.helpdesk.mdcutilities;
    ...
    private void copyToMdc(Context context) {
        if (!context.isEmpty()) {
            ...
            Map<String, String> reactorContextMap = Arrays
                    .stream(HelpdeskServiceTracingUtils.TracingEntry.values())
                    .filter(HelpdeskServiceTracingUtils.TracingEntry::isContextBound)
                    .map(
