        ...
        it.pagopa.generated.ecommerce.helpdesk.v2.model
            ...
            .transactionInfo(
                it.pagopa.generated.ecommerce.helpdesk.v2.model
                    ...
                    .amount(row[10, BigDecimal::class.java]?.toLong())
                    .fee(row[11, BigDecimal::class.java]?.toInt())
                    .grandTotal(row[12, BigDecimal::class.java]?.toLong())
                    ...
                    .details(
                        listOf(
                            it.pagopa.generated.ecommerce.helpdesk.v2.model
                                ...
                                .rptId(null)
                                .amount(row[24, BigDecimal::class.java]?.toLong())
                                .paymentToken(null)
...
fun pmTransactionToTransactionInfoDtoV2(
    ...
    val transactionInfo =
        TransactionInfoDto()
            ...
            .statusDetails(
                pmTransactionHistory.transactionInfo.statusDetails?.let {
                    AccountingStatus.fromCode(it)
                }
            )
            .eventStatus(null)
            .amount(amount)
