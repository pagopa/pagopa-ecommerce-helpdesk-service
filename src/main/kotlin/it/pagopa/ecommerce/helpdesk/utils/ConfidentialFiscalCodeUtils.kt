...
/**
 * Class used for handle fiscal code encryption and decryption.
 *
 * @param fiscalCodeConfidentialDataManager class for execute pdv call
...
class ConfidentialFiscalCodeUtils(
    ...
    /**
     * The method search clear fiscal code into cache if not found make a call to pdv to decrypt the fiscal code
     * then cache it.
     *
     * @param encrypted fiscal code encrypted
     * @return Mono<FiscalCode> return mono with clear fiscal code value object
     */
    ...
    /**
     * The method used for encrypt fiscal code using pdv
     *
     * @param clearText clear fiscal code
     * @return Mono<Confidential<FiscalCode>> return mono with encrypted fiscal code
     */
